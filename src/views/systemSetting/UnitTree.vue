    ...
    export default {
      ...
      methods: {
        ...
        nodeclick(obj,nodetmp,componenttmp){
          ...
          this.$ajax({
            method:"post",
            url: "http://localhost:9080/springboot-vue/unitbilltb/getByUnitcode",
            data: {
        ...
        handleEdit(index,row){
          ...
          this.$ajax({
            method:"post",
            url: "http://localhost:9080/springboot-vue/billchargeitem/getAllItem",
            ...
            this.$ajax({
              method:"post",
              url: "http://localhost:9080/springboot-vue/billchargeitem/selectByBitycode",
              data: {
        ...
        updateBillChargeitem(){
          ...
          this.$ajax({
            method:"post",
            url: "http://localhost:9080/springboot-vue/billchargeitem/updateEbillChargeitem",
            data: {
      ...
      mounted:function () {
        this.$ajax.get('http://localhost:9080/springboot-vue/unit/getUnitTree').then( res => {
